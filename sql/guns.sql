...
CREATE TABLE `sys_news` (
  ...
  `file` mediumtext COMMENT '附加文件',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
  `creater` int(11) DEFAULT NULL COMMENT '新闻创建人',
  PRIMARY KEY (`id`)
...
-- Records of sys_notice
-- ----------------------------
INSERT INTO `sys_news` VALUES ('6', 'News', '10', '党风建设', null , '2017-01-11 08:51:20', '1');
INSERT INTO `sys_news` VALUES ('8', '特别注意', null, '关于×××××情况说明', null , '2018-05-10 19:28:57', '1');
